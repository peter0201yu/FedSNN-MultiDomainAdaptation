...
def args_parser():
    ...
    parser.add_argument('--num_users_per_domain', type=int, default=5, help="number of users of each domain")
    parser.add_argument('--mda_threshold', type=float, default=None, help="entropy threshold for choosing confident samples")
    parser.add_argument('--mda_threshold_frac', type=float, default=None, help="fraction of confident samples among all data samples")
    ...
    # other arguments
    parser.add_argument('--dataset', type=str, default='digit5', help="name of dataset")
